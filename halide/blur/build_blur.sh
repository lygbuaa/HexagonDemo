...
g++ -D _GLIBCXX_USE_CXX11_ABI=0 -std=c++11 $INCLUDES  -g -fno-rtti halide_blur_generator.cpp $HALIDE_ROOT/tools/GenGen.cpp -g $HL_LIBS -o bin/halide_blur.generator -ldl -lpthread -lz
